    ...
    <div className="px-4 mt-2 mb-1 flex items-end justify-between min-h-[32px]">
      ...
      <div className="relative shrink-0 ml-auto">
        <button
          ...
          className="p-1.5 rounded-lg hover:bg-slate-100 hover:text-slate-900 dark:hover:bg-[#3a3b3c] dark:hover:text-[#e4e6eb] transition-colors cursor-pointer text-slate-500 dark:text-[#b0b3b8] outline-none"
        >
          <MoreIcon />
        </button>
        {isMenuOpen && (
