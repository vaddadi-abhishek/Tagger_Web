...
// FACEBOOK ICONS
// ==========================================
export function FacebookBrandLogo({ className = "w-6 h-6 fill-[#1877F2] shrink-0" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className}>
...
// YOUTUBE ICONS
// ==========================================
export function YouTubeBrandLogo({ className = "w-6 h-6 fill-[#FF0000] shrink-0" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className}>
